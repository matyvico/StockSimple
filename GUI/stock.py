...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.botonConsultar, 1, 2, 1, 1)
        self.textoCodigo = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textoCodigo.sizePolicy().hasHeightForWidth())
        self.textoCodigo.setSizePolicy(sizePolicy)
        self.textoCodigo.setObjectName("textoCodigo")
        self.gridLayout.addWidget(self.textoCodigo, 1, 1, 1, 1)
        self.botonBorrar = QtWidgets.QPushButton(self.centralwidget)
        self.botonBorrar.setObjectName("botonBorrar")
        self.gridLayout.addWidget(self.botonBorrar, 1, 3, 1, 1)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 647, 28))
        ...
        MainWindow.setTabOrder(self.textoCodigo, self.botonConsultar)
        MainWindow.setTabOrder(self.botonConsultar, self.botonBorrar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.botonConsultar.setText(_translate("MainWindow", "Consultar"))
        self.botonBorrar.setText(_translate("MainWindow", "Borrar consulta"))
